...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColorAlpha = 0x7F666666;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabsContainer.setPadding(30, 0, 30, 0);
                ...
                if (position != pager.getCurrentItem()) {
                    ...
                    switch (event.getAction()) {
                        ...
                        case MotionEvent.ACTION_CANCEL:
                            tv.setTextColor(tabTextColorAlpha);
                            break;
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (i == 0) {
                    ...
                    tab.setTextColor(tabTextColorAlpha);
                }
    ...
    private void scrollToChild(int position, int offset) {
        ...
        int newScrollX = v.getLeft() - v.getPaddingLeft() - v.getPaddingRight() + offset;
    ...
    public void setTextColor(int textColor) {
        ...
        this.tabTextColorAlpha = addAlpha(tabTextColor, "7F");
        updateTabStyles();
    }
