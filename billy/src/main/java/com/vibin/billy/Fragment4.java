...
public class Fragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Log.d(getClass().getName(), "Size of mdata in fragment4 " + mData.size());
    ...
    public void onSaveInstanceState(Bundle outState) {
        Log.d(getClass().getName(), "Saving the instance state! Frag 4");
    ...
    private void handleXML(String response) throws IOException, XmlPullParserException {
        ...
        while (mIndex < billySong.length) {
            ...
            // Log.d(getClass().getName(), "mIndex in fragment4"+ mIndex);
