...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Log.d(getClass().getName(), "Size of mdata in fragment2 " + mData.size());
    ...
    public void onSaveInstanceState(Bundle outState) {
        Log.d(getClass().getName(), "Saving the instance state! Frag 2");
    ...
    private void handleXML(String response) throws IOException, XmlPullParserException {
        ...
        while (mIndex < billySong.length) {
            ...
            //Log.d(getClass().getName(), "mIndex in fragment2"+ mIndex);
